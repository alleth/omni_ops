...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $siteListTbl->site_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $siteListTbl->site_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="siteListTbl form content">
            ...
            <fieldset>
                <legend><?= __('Edit Site List Tbl') ?></legend>
                <?php
