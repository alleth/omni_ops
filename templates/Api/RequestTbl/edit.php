...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $requestTbl->request_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $requestTbl->request_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="requestTbl form content">
            ...
            <fieldset>
                <legend><?= __('Edit Request Tbl') ?></legend>
                <?php
