...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $itemDescription->item_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $itemDescription->item_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="itemDescription form content">
            ...
            <fieldset>
                <legend><?= __('Edit Item Description') ?></legend>
                <?php
